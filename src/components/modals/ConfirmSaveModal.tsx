      ...
      <div className="relative w-full max-w-md max-h-[90vh] overflow-y-auto bg-white border border-[#E4E9E6] rounded-3xl shadow-2xl p-6 sm:p-8 relative text-center my-auto">
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          <button
            type="button"
            onClick={onConfirm}
            className="py-3 px-4 rounded-xl bg-[#05C46B] hover:bg-[#04A75B] text-white text-xs font-extrabold shadow-md shadow-[#05C46B]/20 transition-all flex items-center justify-center space-x-2"
          >
